...
export default defineSchema({
	...
	// Market
	// =====================================================================
	items: items.table().index('by_itemNo', ['itemNo']),
	...
	// Insight
	// =====================================================================
	locations: locations.table().index('by_code', ['code']),
	...
	// Replenishment
	// =====================================================================
	vendors: vendors.table().index('by_vendorNo', ['vendorNo']),
	...
	// POS
	// =====================================================================
	terminals: terminals.table().index('by_terminalCode', ['terminalCode']),
	...
	shipmentMethods: shipmentMethods.table().index('by_code', ['code']),
})
