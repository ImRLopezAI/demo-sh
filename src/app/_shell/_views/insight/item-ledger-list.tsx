...
export default function ItemLedgerList({
	...
	return (
		<div className='space-y-8 pb-8'>
			<PageHeader
				title={specProps?.title ?? 'Item Ledger Entries'}
				description={
					specProps?.description ??
					'Track all inventory movements including sales, purchases, adjustments, and transfers.'
				}
			/>
			...
			<div className='overflow-hidden rounded-xl border border-border/50 bg-background/50 shadow-sm backdrop-blur-xl'>
				...
				>
					...
					<DataGrid.Columns>
						{specProps?.columns ? (
							renderSpecColumns<ItemLedgerEntry>(
								DataGrid.Column,
								specProps.columns,
							)
						) : (
