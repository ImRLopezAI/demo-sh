...
function Card({
	...
	return (
		<div
			...
			data-size={size}
			className={cn(
				'group/card flex flex-col gap-4 overflow-hidden rounded-lg border border-border/75 bg-card/90 py-4 text-card-foreground text-xs/relaxed shadow-xs transition-all duration-200 has-[>img:first-child]:pt-0 hover:shadow-sm data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg',
				className,
			)}
			{...props}
		/>
